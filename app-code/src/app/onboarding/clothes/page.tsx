...
export default function OnboardingClothes() {
  ...
  return (
    ...
    >
      ...
      {/* Titre centré */}
      <div className="absolute" style={{ top: "calc(200px + env(safe-area-inset-top, 0px))", left: 24, right: 24 }}>
        <h1
          style={{
            fontSize: 32,
            fontWeight: 800,
      ...
      <div className="absolute pointer-events-none" style={{ left: 242, top: "calc(234px + env(safe-area-inset-top, 0px))", width: 122, height: 10 }}>
        <Image src="/onb-underline-clothing.png" alt="" fill className="object-contain" />
      </div>
      <div className="absolute pointer-events-none" style={{ left: 208, top: "calc(271px + env(safe-area-inset-top, 0px))", width: 105, height: 10 }}>
        <Image src="/onb-underline-trading.png" alt="" fill className="object-contain" />
      </div>

      {/* "Select" centré */}
      <div className="absolute" style={{ top: "calc(302px + env(safe-area-inset-top, 0px))", left: 0, right: 0 }}>
      ...
      <div
        ...
        style={{ top: "calc(338px + env(safe-area-inset-top, 0px))", left: 66, right: 66, gap: 12, zIndex: 5 }}
      >
        {CATEGORIES.map((cat) => {
